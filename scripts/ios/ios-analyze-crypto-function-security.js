...
// phát hiện việc sử dụng các thuật toán, mode, key hoặc hash yếu trong các hàm mã hoá/hàm băm của libSystem.B.dylib 
// (thư viện chuẩn Apple chứa CommonCrypto).

// Phát hiện:
// Ứng dụng có dùng thuật toán mã hoá yếu (DES, RC4, 3DES, Blowfish, …)
// Dùng mode không an toàn (như ECB hoặc CBC không random IV)
// Key hoặc IV bị tái sử dụng
// PBKDF2 iterations quá thấp (dễ brute-force)
// Dùng hash yếu (MD5, SHA1, MD4…)
